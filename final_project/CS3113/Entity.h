...
enum Animation    { WALK_LEFT, PLAYER_IDLE, PLAYER_SHOVEL_FRONT, 
    PLAYER_SHOVEL_BACK, PLAYER_AXE_FRONT, PLAYER_AXE_BACK, PLAYER_AXE_RIGHT, 
    PLAYER_AXE_LEFT, PLAYER_WATER_FRONT, PLAYER_WATER_BACK, PLAYER_WATER_RIGHT,
    PLAYER_WATER_LEFT, WALK_RIGHT, WALK_UP, WALK_DOWN };
    
enum EntityStatus { ACTIVE, INACTIVE                                          };
enum EntityType   { PLAYER, BLOCK, PLATFORM, NPC, EMPTY, UI_ITEM, ENTITY_NONE };
