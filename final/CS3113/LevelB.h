...
private:
    ...
    enum ItemType {
        ITEM_WHEAT_CROP, ITEM_TURNIP_CROP, ITEM_PEACH,
        ITEM_WOOD, ITEM_CARROT_CROP, ITEM_LETTUCE_CROP,
        ITEM_WHEAT_SEED, ITEM_TURNIP_SEED, ITEM_CARROT_SEED,
        ITEM_LETTUCE_SEED
    };
    ...
    bool mission_carrot = false;
    bool mission_lettuce = false;
