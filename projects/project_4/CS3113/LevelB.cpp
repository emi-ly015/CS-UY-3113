...
void LevelB::initialise()
{
   ...
   */
   mGameState.map = new Map(
      ...
      "assets/project4_assets/finalFINAL.png",   // texture filepath
   ...
   */
   ...
   mGameState.enemy = new Entity(
      ...
      { 100.0f, 100.0f },
      "assets/project4_assets/Red_Run.png",
      ATLAS,
      { 2, 5 },
      flyerAnimationAtlas,
      NPC
...
void LevelB::update(float deltaTime)
{
   ...
   mGameState.enemy->flyDirection(mOrigin.x - 300.0f, mOrigin.x + 300.0f);
