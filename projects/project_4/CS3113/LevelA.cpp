...
void LevelA::initialise()
{
   ...
   */
   mGameState.map = new Map(
      ...
      "assets/project4_assets/finalFINAL.png", 
   ...
   */
   ...
   mGameState.player = new Entity(
      {mOrigin.x - 400.0f, mOrigin.y }, // position
      {100.0f * sizeRatio, 110.0f},             // scale
   ...
   */
   ...
   mGameState.enemy = new Entity(
        {mGameState.player->getPosition().x - 200.0f, 
         mOrigin.y},                            // position
        {100.0f, 100.0f},                       // scale
        "assets/project4_assets/Blue_Run.png",                // texture file address
        ATLAS,                                  // single image or atlas
        {2, 5},                                 // atlas dimensions
        followerAnimationAtlas,                 // actual atlas
        NPC                                     // entity type
   );

   //  follower floats since it looks like a ghost 
